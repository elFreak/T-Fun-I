...
public class ProgramFlow extends JPanel implements ActionListener {
	...
	private JButton btBerechnen = new JButton(
			"<html><center> <b>Berechnen</b> <p/> " + "(�bertragungsfunktion)</html>");
	private JButton btVertifizieren = new JButton(
			"<html><center><b>Verifizieren</b> <p/> " + "(�bertragungsfunktion)</html>");
	...
	protected void paintComponent(Graphics g) {
		...
		int textWidthMax = (fm.stringWidth(" (�bertragungsfunktion) "));
